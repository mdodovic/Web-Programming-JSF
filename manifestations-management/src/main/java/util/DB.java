    ...
    private DB() { // za MySQL
        try {
            ...
            for (int i = 0; i < MAX_CON; i++) {
                ...
                // bafer[i] = DriverManager.getConnection("jdbc:mysql://localhost:3306/jsf_lab_2020?useSSL=false","root","");
                // u slucaju problema sa vremenskim zonama u workbenchu ili phpmyadminu izvrsiti sledece komande
                // SET @@global.time_zone='+00:00';
                // SET @@session.time_zone='+00:00';
                bafer[i] = DriverManager.getConnection("jdbc:mysql://localhost:3306/jsf_lab_2020?useSSL=false","root","matija");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
